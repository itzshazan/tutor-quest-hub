...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative overflow-hidden py-24 md:py-36" style={{ background: "var(--hero-gradient)" }}>
      {/* Decorative blobs */}
      ...
      <div className="container relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.div
            ...
            className="mx-auto mt-10 flex max-w-3xl flex-col gap-3 rounded-2xl border bg-card p-4 shadow-elevated sm:flex-row sm:items-center sm:flex-wrap"
          >
